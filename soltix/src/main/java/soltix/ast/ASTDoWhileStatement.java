...
public class ASTDoWhileStatement extends ASTNode implements IControlStructure {
    ...
    @Override
    public String toSolidityCodePostfix() throws Exception { return "while (" + condition.toSolidityCode() + ");"; }

    @Override
    public void finalize() throws Exception {
        if (getChildCount() != 2) {
            throw new Exception("Unexpected do-while child count " + getChildCount() + " = " + childrenToText());
        }
